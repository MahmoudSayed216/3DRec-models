...
class Decoder(nn.Module):
    def __init__(self, configs):
        ...
        self.upsample1 = nn.Sequential(nn.ConvTranspose3d(in_channels=9408, out_channels=768, kernel_size=4, stride=2, padding=1, bias=bias),
